...
\subsection{Measurement statistics}
...
\begin{figure*}[htb]
  ...
  % \subfloat[Record 100]{%
  % \includegraphics[width=0.3\linewidth]{measurements/rec_100_hist_measurements_200_bins.png}}
  %   \hfill
  % \subfloat[Record 102]{%
  % \includegraphics[width=0.3\linewidth]{measurements/rec_102_hist_measurements_200_bins.png}}
  %   \hfill
  % \subfloat[Record 115]{%
  % \includegraphics[width=0.3\linewidth]{measurements/rec_115_hist_measurements_200_bins.png}}
  %   \\
  % \subfloat[Record 202]{%
  % \includegraphics[width=0.3\linewidth]{measurements/rec_202_hist_measurements_200_bins.png}}
  %   \hfill
  % \subfloat[Record 208]{%
  % \includegraphics[width=0.3\linewidth]{measurements/rec_208_hist_measurements_200_bins.png}}
  %   \hfill
  % \subfloat[Record 234]{%
  % \includegraphics[width=0.3\linewidth]{measurements/rec_234_hist_measurements_200_bins.png}}
...
\begin{figure*}[htb]
  ...
  % {measurements/rec_234_empirical_vs_quantized_gaussian.png}
...
\centering 
% \includegraphics[width=0.95\textwidth]
% {images/rec_100_q_0_7_d_4_m_256_n_512_b_32.png}
